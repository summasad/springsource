...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository {
    ...
    public List<Object[]> list() {
        ...
        // SELECT b.bno, b.title, (SELECT COUNT(r.rno) FROM REPLY r WHERE b.bno=
        // r.BOARD_BNO) AS r_cnt, b.WRITER_EMAIL, b.REGDATE, m.name
    ...
    public Page<Object[]> list(String type, String keyword, Pageable pageable) {
        ...
        if (type != null) {
            ...
            // gno>0 and (content like '%검색어%' or title like '%검색어%' or writer like '%검색어%')
