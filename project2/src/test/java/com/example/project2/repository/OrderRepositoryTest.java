...
public class OrderRepositoryTest {
    ...
    public void insertOrderTest() {
        ...
        LongStream.rangeClosed(1, 3).forEach(i -> {
            Order order = Order.builder()
                    ...
                    .product(Product.builder().id(i).build()).build();
    ...
    public void testQueryMethod() {
        // System.out.println(jpqlMemberRepository.findByNameContaining("user1"));
    ...
    public void queryDslTest() {
        ...
        // Iterable<Product> products =
        // productRepository.findAll(qProduct.name.eq("제품1").and(qProduct.price.gt(500)));
        // for (Product product : products) {
        // System.out.println(product);
        // }
        ...
        // Iterable<Product> products =
        // productRepository.findAll(qProduct.name.eq("제품1").and(qProduct.price.goe(500)));
        // for (Product product : products) {
        // System.out.println(product);
        // }

        // 상품명이 제품 1 이고, 가격이 500 이상인 상품 조회(booleanBuilder)
